...
<!--                        <div class="card  first-product p-4">
                            <h2 class="py-4 font-weight-bold product-category">ITEM 1</h2>
                            <div class="row">
                                 div for images 
                                <div
                                    class="col-md-5 col-11 mx-auto bg-light d-flex justify-content-center align-items-center shadow product-img">
                                    <img src="images/product-img/b-1.jpg" class="img-fluid cart-image" alt="">
                                ...
                                <div class="col-md-7 coll-11 mx-auto px-sm-5 px-md-3 mt-2 pro-detail">
                                    <div class="row">
                                        ...
                                        <div class="col-8  card-title">
                                            <h3 class="mb-4 product-name text-uppercase ">Titanium Bracelet</h3>
                                            <p class="mb-2">COLOR - WHITE</p>
                                            <p class="mb-2"> WEIGHT - 300GM</p>
                                            <p class="mb-4 pdescr"> FINISHING - GOLD</p>
                                        </div>
                                         Quantity 
                                        <div class="col-4 quantitybtn ">
                                            <ul class="pagination d-flex justify-content-end  set-quantity">
                                                ...
                                                <li class="page-item ">
                                                    <input type="text" name="" class="page-link " value="1" id="textbox1" >
                                                </li>
                                                <li class="page-item">
                                    ...
                                    <div class="row remove-wish">
                                        <div class="col-8 d-flex justify-content-between align-items-end remove-wish">
                                            <p class="h6"><i class="fas fa-trash px-1"></i>REMOVE ITEM</p>
                                            <p class="h6"><i class="fas fa-heart px-1"></i>ADD TO WISHLIST</p>
                                        </div>
                                        <div class="col-4 d-flex justify-content-end  price-money">
                                            <h5 class="price-indivi">$<span id="itemval1">0.00 </span></h5>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<!--                        <div class="card p-4">
                            <h2 class="py-4 font-weight-bold">ITEM 2</h2>
                            <div class="row">
                                 div for images 
                                <div
                                    class="col-md-5 col-11 mx-auto bg-light d-flex justify-content-center align-items-center shadow product-img">
                                    <img src="images/product-img/b-1.jpg" class="img-fluid" alt="">

                                </div>
                                 card product details 
                                <div class="col-md-7 coll-11 mx-auto px-sm-5 px-md-3 mt-2 ">
                                    <div class="row">
                                         product name 
                                        <div class="col-8  card-title">
                                            <h3 class="mb-4 product-name text-uppercase">Titanium Bracelet</h3>
                                        ...
                                        <div class="col-4 quantitybtn ">
                                            <ul class="pagination d-flex justify-content-end  set-quantity">
                                                ...
                                                <li class="page-item ">
                                                    <input type="text" name="" class="page-link " value="1" id="textbox2" >
                                                </li>
                                                <li class="page-item">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-4 d-flex justify-content-end  price-money">
                                            <h5 class="price-indivi">$<span id="itemval2">0.00 </span></h5>
                                        </div>
                                    </div>
                                </div>
                            </div>
